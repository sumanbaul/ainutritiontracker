...
dotnet tool restore
dotnet tool run dotnet-ef database update --project src/NutritionTracker.Infrastructure --startup-project src/NutritionTracker.Api --connection $ConnectionString
