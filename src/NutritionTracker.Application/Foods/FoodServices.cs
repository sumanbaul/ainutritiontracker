...
public sealed record FoodSummary(Guid Id, string DisplayName, string CanonicalName, string? RegionalName, FoodCategory Category, Cuisine Cuisine, PreparationMethod PreparationMethod, FoodState FoodState, FoodNutritionValues NutritionPer100Grams, bool IsVerified, bool IsUserCreated, bool IsEstimate, FoodMatchType MatchType, IReadOnlyList<string> ServingUnits);
public sealed record FoodDetails(Guid Id, string CanonicalName, string DisplayName, string? Description, FoodCategory Category, Cuisine Cuisine, PreparationMethod PreparationMethod, FoodState FoodState, FoodNutritionValues NutritionPer100Grams, IReadOnlyList<string> Aliases, IReadOnlyList<ServingConversionResult> ServingConversions, string DataSource, string? SourceReference, string? SourceVersion, bool IsVerified, bool IsUserCreated, bool IsEstimate);
