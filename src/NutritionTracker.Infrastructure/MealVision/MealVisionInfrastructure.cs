...
public sealed class MealVisionProviderResolver(IEnumerable<IMealVisionProvider> providers, IOptions<MealVisionOptions> options) : IMealVisionProviderResolver
{
    public IMealVisionProvider Resolve()
    {
        var name = options.Value.Provider.ToString();
